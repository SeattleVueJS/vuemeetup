# Code of Conduct – Seattle Vue Meetup

## Purpose

This group is a volunteer-run
user group, and invites anyone with a desire to talk and learn about Vue.js and
related technologies to gather together, share their knowledge, and promote the
Vue community in the Seattle, WA, and Puget Sound area.

Seattle VueJS desires to be inclusive to the largest number of contributors as
...
We invite all those who participate in Seattle VueJS to help us in creating such an
environment.
...
contact the organizers at tessamero@gmail.com, send a direct message to
[@seattlevuejs](https://twitter.com/seattlevuejs) on twitter, or speak to an organizer
in person at an event.

The current organizers are:

* Tessa Mero ([@TessaMero](https://twitter.com/TessaMero)) tessamero@gmail.com
...
* Remember that your emails are sent to all subscribers and that they are
  ...
  website](http://www.meetup.com/seattlevuejs/messages/archive/).
...
Seattle VueJS is a community effort. If you would like to suggest amendments or
